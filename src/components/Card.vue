...
<div>
  <div class="kbtu" >
  <img class="kbtu-logo" src="https://kbtu.kz/images/logoWh.svg"/>
  <span> Kazakh-British<br>
   Technical University </span>
  </div>
  <p>Please, close your existing bank card, to activate Campus card.</p>
